...
<html lang = "en">
	<head>
	    ...
	    <link href = "https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel = "stylesheet">
   		...
   		<link href = "${contextPath}/resources/static/css/recovery.css" rel = "stylesheet">
	...
	<body>
		...
		<div class = "row row-cols-1 row-cols-md-2 g-3 p-5">
			<div id = "user-recovery-card" class = "col">
				<!-- CARD ONE -->
				<div class = "card h-100">
					<img src = "${contextPath}/resources/static/images/pages/home-page/cards/strawberries.jpg" class = "card-img-top img-fluid h-100">
				  	<div class = "card-body">
				    	<h5 class = "card-title text-center">USERNAME RECOVERY</h5>
				    	<p class = "card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
				  	</div>
				</div>
			</div>
			<!-- CARD TWO -->
			<div id = "pass-recovery-card" class = "col">
				<div class = "card h-100">

...
<html lang = "en-US">
	<head>
	    ...
	    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet">
   		...
   		<link href = "${contextPath}/resources/static/css/home-page.css" rel = "stylesheet">
	...
	<body>
		...
		<div id = "mainContent" class = "p-5 align-middle">
			...
			<div class="row row-cols-1 row-cols-md-3 g-3">
				<div class="col">
					...
					<div class = "card h-100 m-2">
						<img src="${contextPath}/resources/static/images/pages/home-page/cards/strawberries.jpg" class="card-img-top img-fluid">
					  	<div class="card-body">
					    	<h5 class="card-title">STRAWBERRIES</h5>
					    	<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
					  	</div>
					  	<div class="card-footer">
					  		<img src = "${contextPath}/resources/static/images/icons/home-page/card/globe.svg" class = "card-icons" alt="webIcon" width="28" height="28">
					  	</div>
					</div>
				</div>
				<!-- CARD TWO -->
				<div class="col">
					<div class = "card h-100 m-2">
						<img src="${contextPath}/resources/static/images/pages/home-page/cards/orange.jpg" class="card-img-top img-fluid">
					  	<div class="card-body">
				...
				<div class="col">
					<div class = "card h-100 m-2">
						<img src="${contextPath}/resources/static/images/pages/home-page/cards/bananas.jpg" class="card-img-top img-fluid">
					  	<div class="card-body">
				...
				<div class="col">
					<div class = "card h-100 m-2">
						<img src="${contextPath}/resources/static/images/pages/home-page/cards/kiwi.jpg" class="card-img-top img-fluid">
					  	<div class="card-body">
				...
				<div class="col">
					<div class = "card h-100 m-2">
						<img src="${contextPath}/resources/static/images/pages/home-page/cards/blueberries.jpg" class="card-img-top img-fluid">
					  	<div class="card-body">
				...
				<div class="col">
					<div class = "card h-100 m-2">
						<img src="${contextPath}/resources/static/images/pages/home-page/cards/grapes.png" class="card-img-top img-fluid">
					  	<div class="card-body">
				...
				<div class="col">
					<div class = "card h-100 m-2">
						<img src="${contextPath}/resources/static/images/pages/home-page/cards/dragonfruit.jpg" class="card-img-top img-fluid">
					  	<div class="card-body">
					  	...
					  	<div class = "card-footer">
					  		<span class = "align-middle"><img src = "${contextPath}/resources/static/images/icons/home-page/card/globe.svg" class = "card-icons" alt = "webIcon" width="28" height="28"></span>
					  	</div>
					</div>
				</div>
			</div>
